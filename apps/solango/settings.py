...
#### SOLR
#SOLR_ROOT = getattr(settings,"SOLR_ROOT", "/Users/mredar/dev/solr/example")
#SOLR_SCHEMA_PATH = os.path.join(SOLR_ROOT, 'solr/conf/schema.xml')
#SOLR_DATA_DIR = os.path.join(SOLR_ROOT, 'solr/data')
